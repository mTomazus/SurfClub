...
<link href="https://fonts.googleapis.com/css2?family=Baskervville:ital@0;1&family=Racing+Sans+One&family=Sigmar+One&display=swap" rel="stylesheet">
<base href="<?= BASE_URL ?>">
...
<link rel="stylesheet" href="<?= BASE_URL ?>css/admins-area.css">
