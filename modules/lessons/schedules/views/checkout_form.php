<div id="form">
    <div class="d-flex space-between mb-1">
        <h2>Registracija</h2>
        <h3 style="margin:auto;"><?= out($lessons->name) ?></h3>
     </div>
    <div class="d-flex space-between mb-1">
    ...
    <?php
        echo form_open('lessons-schedules/checkout_form', array('id'=>'checkout-form'));
    ...
    ?>
    <button class="close alt" onclick="closeModal()">Atšaukti</button>
    <?php
