<?php
class Lesson_users extends Trongate {
    ...
    public function create(): void {
        ...
        if ($update_id>0) {
            $data['headline'] = 'Update Lesson User Record';
            $data['cancel_url'] = BASE_URL.'lesson_users/show/'.$update_id;
        } else {
            $data['headline'] = 'Create New Lesson User Record';
            $data['cancel_url'] = BASE_URL.'lesson_users/manage';
        }

        $data['form_location'] = BASE_URL.'lesson_users/submit/'.$update_id;
    ...
    public function manage(): void {
        ...
        $pagination_data['pagination_root'] = 'lesson_users/manage';
    ...
    public function show(): void {
        ...
        if ($data === false) {
            ...
            $data['headline'] = 'Lesson_user Information';
            $data['view_file'] = 'show';
            $this->template('admin', $data);
        }
    }
    ...
    public function submit(): void {
        ...
        if ($submit === 'Submit') {
            ...
            if ($result === true) {
                ...
                redirect('lesson_users/show/'.$update_id);
