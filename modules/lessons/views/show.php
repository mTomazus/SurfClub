...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('lessons/manage', 'View All Lessons', array("class" => "button alt"));
        echo anchor('lessons/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="three-col">
    ...
    <?= Modules::run('module_relations/_draw_summary_panel', 'lesson_schedules', $token) ?>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('lessons/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a lesson record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
