...
<div class="text-div">
    <p>
        To get started, log into the <a href="tg-admin">admin panel</a>. From the admin panel, you'll be able to easily edit <i>this</i> page or create entirely <i>new</i> pages. The default login credentials for the admin panel are as follows:
    </p>
    <p>
        <?php
...
<div class="button-div" style="cursor: pointer; font-size: 1.2em;">
    <div style="text-align: center;">
        ...
        <button onclick="window.location='members/create_account';">Create Account</button>
        <button onclick="window.location='members/login';">Members Login</button>
