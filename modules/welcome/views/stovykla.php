...
<div class="hero-4 hero">
    <video autoplay muted loop>
        <source src="videos/web-camp-2.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
    <!-- ka suteiks stovykla-->
     <section>
...
<div class="hero">
    ...
    <section>
        <p>Jaunieji stovyklos auklėtiniai dalyvauja tiek Lietuvos/Latvijos tiek 
            Pasaulio čempionatuose. Eilę metų mūsų mokiniai užėma prizines 
            lietuvos čempionato vietas. 2024 metais net 3 mūsų sportininkai 
            išvyko į Pasaulio jaunimo čempionatą atstovauti Lietuvą. 
    ...
    <div class="team">
        <div class="team-card">
            ...
            <div class="team-article">
                ...
                <article>Ilgametis sporto treneris</article>
                <article>Tarptautinės klasifikacijos teisėjas</article>
            </div>
        </div>
        <div class="team-card">
            ...
            <div class="team-article">
                ...
                <article>Profesionalus gelbėtojas</article>
                <article>Karys savanoris</article>
            </div>
        </div>
        <div class="team-card">
            ...
            <div class="team-article">
                ...
                <article>Kovos menų ekspertas</article>
                <article>Keliautojas</article>
            </div>
        </div>
    </div>
    <article>
