...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('coupons/manage', 'View All Coupons', array("class" => "button alt"));
        echo anchor('coupons/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="record-details">
                ...
                <div class="row">
                    <div>Date Formed</div>
                    <div><?= date('l jS F Y',  strtotime($date_formed)) ?></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('coupons/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Coupon record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
