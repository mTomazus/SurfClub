...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('galleries/manage', 'View All Galleries', array("class" => "button alt"));
        echo anchor('galleries/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        ...
        <p>Are you sure?</p>
        <p>You are about to delete a Gallery record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
