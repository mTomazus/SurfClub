...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('enquiries/manage', 'View All Enquiries', array("class" => "button alt"));
        echo anchor('enquiries/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="two-col">
    <div class="card record-details">
        ...
        <div class="card-body">
            ...
            <div>
                <b>Message</b>
                <div style="margin-top: 1em;"><?= nl2br($message) ?></div>
            </div>
        </div>
    </div>
    <div class="card">
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('enquiries/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
