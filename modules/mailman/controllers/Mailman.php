...
class Mailman extends Trongate {

    /*
    Set your email settings in the function _send_my_email
               -- starting on line 775.

    Debug mode -- Set line 804 $mail->SMTPDebug to 'true'.
          Note -- No redirects in debug mode.
    */
    ...
    function _send_my_email($data){
        ...
        $mail->setFrom('Sent from email', 'Sent from name');  
        $mail->addReplyTo('Set a reply email','No Reply');
        $mail->addAddress($to, '');        
     ...
     */
    public function setLanguage($langcode = 'cs', $lang_path = '')
    {
        ...
        if (empty($lang_path)) {
            ...
            $lang_path = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'assets/language' . DIRECTORY_SEPARATOR;
        }
