<div class='container'>
    ...
    <div class="button-div" style="cursor: pointer; font-size: 1.2em;">
        <div style="text-align: center;">
            ...
            <button onclick="window.location='[website]members/create_account';">Create Account</button>
            <button onclick="window.location='[website]members/login';">Members Login</button>
