...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('camps/manage', 'View All Camps', array("class" => "button alt"));
        echo anchor('camps/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('camps/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Camp record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
