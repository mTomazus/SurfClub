...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('lesson_users/manage', 'View All Lesson_users', array("class" => "button alt"));
        echo anchor('lesson_users/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
        ...
        <div class="card-body">
            <div class="record-details">
                ...
                <div class="row">
                    ...
                    <div><?= date('l jS F Y \a\t H:i',  strtotime($registration_date)) ?></div>
                </div>
            </div>
        </div>
    </div>
