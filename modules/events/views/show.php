...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('events/manage', 'View All Events', array("class" => "button alt"));
        echo anchor('events/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="record-details">
                ...
                <div class="row">
                    <div>start_time</div>
                    <div><?= date('l jS F Y \a\t H:i',  strtotime($start_time)) ?></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('events/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete an Event record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
